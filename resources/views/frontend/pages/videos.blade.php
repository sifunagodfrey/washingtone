...
@section('title', 'Videos | Washingtone Oruko')
@section('meta_description', 'Watch Washingtone Oruko in action — MC, team building, motivational talks and more on YouTube.')

@section('content')
<section class="py-5 bg-primary text-white position-relative overflow-hidden" data-aos="fade-down">
    <div class="position-absolute top-0 start-0 w-100 h-100">
        <img src="{{ asset('images/washingtone-oruko-on-stage-singing-3-main.jpg') }}" class="w-100 h-100 object-fit-cover opacity-20" alt="">
    </div>
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="d-flex justify-content-center mt-5">{{ $videos->links() }}</div>
