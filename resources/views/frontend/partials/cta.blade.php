    ...
    <div class="container">
        <div class="row align-items-center g-4">
            ...
            <div class="col-lg-4 d-flex flex-wrap gap-3 justify-content-lg-end">
                <a href="{{ route('contact.index') }}" class="btn btn-warning btn-lg px-4 rounded-pill fw-semibold">
                    <i class="fas fa-envelope me-2"></i>Get In Touch
                </a>
                <a href="https://wa.me/{{ $wa }}?text=Hi%20Washingtone%2C%20I%27d%20like%20to%20book%20you%20for%20an%20event."
