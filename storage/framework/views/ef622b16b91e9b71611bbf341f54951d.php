...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid py-4" style="background:#f8f9fa; min-height:100vh;">
        ...
        <div class="mb-4">
            <h2 class="fw-bold text-primary">Create Receipt</h2>
            <small class="text-muted">Generate a new payment receipt</small>
        </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control"
                                value="<?php echo e($receiptNumber); ?>" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            <label class="form-label">
                                Client
                                <span id="clientLockedBadge" class="badge bg-secondary ms-1 d-none">Auto-filled</span>
                            </label>
                            <input type="hidden" name="client_id" id="client_id_hidden">
                            <select name="_client_display" id="client_id_select" class="form-select">
